...
export const MUTATIONS: Record<number, MutationEntry> = {
  ...
  71: { text: 'Track must abandon its intended Track Type.' },
  ...
  81: { text: 'Purpose of Track changes to match previous Room. If Room One, re-roll.', mechanics: { roomOneRule: 'reroll' } },
  83: { text: "Repeat last Room's Mutation. If first Room, no Mutation.", mechanics: { roomOneRule: 'no-mutation' } },
  85: { text: 'Once you begin composing, the Room finalizes in three minutes.' },
  ...
  97: { text: 'Roll Mutations 80 or higher = delete Track. If Room One, no Mutation.', mechanics: { roomOneRule: 'no-mutation' } },
...
export const TARGET_CURSES: Record<number, TargetCurseEntry> = {
  ...
  33: { text: 'Force a Room. Next Room will have two Mutations.', mechanics: { forceRoom: true } },
  37: { text: 'Turn Track down -6 dB.' },
  41: { text: 'Strip all effects.' },
  45: { text: 'This Track is now target of all future Curses until end of Run.' },
  49: { text: 'Over-compress.' },
  53: { text: 'When discarding Run, roll d100. On 51+, force another Room.', mechanics: { forceRoom: true } },
...
export const MIX_CURSES: Record<number, MixCurseEntry> = {
  1: { text: 'This is the last Room. If Room One or Two, re-roll.', mechanics: { isLastRoom: true } },
